...
ADD db_scripts/dbobjects/cfg/tables/users1.sql /docker-entrypoint-initdb.d/2/users1.sql
ADD db_scripts/dbobjects/cfg/functions/users2_get.sql /docker-entrypoint-initdb.d/1/users2_get.sql
